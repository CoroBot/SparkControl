...
class MainUserWindow(QtGui.QMainWindow):
    ...
    def __init__(self):
        '''
        Initialization of the Object creates a window
        with provided dimensions and constraints
        '''
    ...
    def setIcon(self):
        ...
        SparkIcon = QtGui.QIcon('icon2.png')
...
#        self.setCentralWidget(self.videoPortal)
    ...
    def CreateDockWidgets(self):
        '''
        Method creates the dockable widgets within the window.
        Within this method is a description
        of the actual widgets being created;
        instances of button panels and etc.
        '''
        ...
        self.driveButtons = DirectionalButtons(self, 'Forward', 'Right',
                                               'Reverse', 'Left',
                                               'Duty Cycle')
        ...
        self.cameraButtons = DirectionalButtons(self, 'Up', 'Right', 'Down',
                                                'Left', 'Sensitivity')
        ...
        self.frontInfrarredSensor = DigitalDisplay(self,
                                                   'Front IR Sensor',
                                                   'cm')
        ...
        self.frontLeftUltrasonicSensor = DigitalDisplay(self,
        ...
        self.frontRightUltrasonicSensor = DigitalDisplay(self,
        ...
        self.rearUltrasonicSensor = DigitalDisplay(self,
                                                   'Rear Ultrasonic',
                                                   'cm')
...
if __name__ == '__main__':
    '''It is best practice to use this type of wrapper to in the
    event that someone else
